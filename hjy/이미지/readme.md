...
| Conv2Former       | 약 29백만   | conv modulation, token mixer     | ConvNeXt보다 다양한 task에서 우수 | 2022  | JD Explore Academy    |
| NEXcepTion        | 약 20.5백만 | NAS 기반 구조 탐색 + separable conv    | 적은 연산량, 높은 처리량과 정확도      | 2022  | Alibaba DAMO Academy  |
| ConvNeXtV2-Base   | 약 89백만   | MAE pretraining, GRN             | self-supervised 학습에 최적화  | 2023  | Meta AI               |
| InceptionNeXt     | 약 28백만   | Inception 구조 + large kernel conv | 연산 효율성 향상, 정확도 증가        | 2023  | Huawei Noah’s Ark Lab |
